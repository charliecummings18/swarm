...
const double ALIGN_VISIBILITY = 10.0;
const double COHESION_VISIBILITY = 10.0;
const double SEPERATION_VISIBILITY = 10.0;
const double PREDATOR_VISIBILITY = 10.0;
